    ...
    try:
        ...
        if 'hello' in command:
            ...
            print('''i can play songs on youtube , tell you a joke, search on wikipedia, tell date and time,find your 
                    ...
                    stack overflow,w3schools and searches on google. What can i do for you??''')
            engine_talk('''i can play songs on youtube , tell you a joke, search on wikipedia, tell date and time,find 
                        your location, locate area on map,open different websites like insta gram, youtube,gmail,
                         git hub, stack overflow, w3schools and searches on google.What can i do for you??''')
...
print('\n')
print("hello, greetings of the day i am your virtual assistant.What can i do for you ??")
engine_talk("hello, greetings of the day, i am your virtual assistant what can i do for you?! ")
while True:
    run_alexa()
